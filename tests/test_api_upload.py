...
# Set AWS env vars early so boto3/moto never tries real AWS
...
def test_upload_model_success(mock_aws_services):
    ...
    with patch.dict(
        ...
        from src.api.routes import app, _init_aws_clients
        ...
        s3_objects = mock_aws_services["s3"].list_objects_v2(
            Bucket=mock_aws_services["bucket_name"]
        )
